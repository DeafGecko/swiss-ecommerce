    ...
    <header className="border-b border-[var(--color-border)] bg-[var(--color-background)] sticky top-0 z-50">
      <div className="container mx-auto px-3 sm:px-4 h-14 sm:h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 tracking-tight">
          ...
          <span className="phase-name-p2 inline-flex items-center gap-3">
            <span className="brand-icon inline-flex items-center justify-center w-8 h-8 bg-[#1a1a1a] text-white rounded-md flex-shrink-0" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1.1rem', fontWeight: 400, lineHeight: '1' }}>M</span>
            <span className="brand-name text-xl sm:text-2xl font-semibold" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", letterSpacing: '0.04em', lineHeight: '1' }}>Monolith</span>
          </span>
        </Link>
